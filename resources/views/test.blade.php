                                ...
                                <div class="card h-100">
                                    ...
                                    <form action="/addToCart" method="get">
                                        ...
                                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                            <div class="text-center"><button class="btn btn-outline-dark mt-auto" id="addToCart" name="productId" value="{{$product->id}}">Add to Cart</button></div>
                                        </div>
                                    </form>
...
$(document).ready(function() {
    ...
    $('#mensProductBtn').click(function(e) {
      $('#mensSection').show(''); $('#womansSection').hide('');
    });

    $('#womensProductBtn').click(function(e) {
      $('#womansSection').show(''); $('#mensSection').hide('');
    });

    $('#allProductBtn').click(function(e) {
      $('#womansSection').show(''); $('#mensSection').show('');
    });


    $('#addToCart').click(function(e){
      $('#cart').html(function(i, val) { return +val+1 });
